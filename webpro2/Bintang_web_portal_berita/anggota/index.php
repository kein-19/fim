...
if(isset($_POST['submit'])){
    ...
    elseif($pass == ""){
        ...
        $cekanggota = mysqli_query($connect, "SELECT * FROM tb_anggota WHERE nama = '$user' AND password = '$passmd5'");
        ...
        if($ada > 0){
            ...
            $_SESSION['owner'] = $idanggota; //jadikan session
            echo "<script>alert('Selamat Datang !'); document.location= 'home.php'</script>";
        }
        else{
            $pass_error = "<span style= 'color: #FFF; margin-left: 10px;'> Username atau Password Salah </span>";
        }
    }
}
    ...
    <?php include "../header.php"; ?>
        ...
        <div class="konten">
            <div class="konten-kiri">  
                ...
                <tr><td>
                    <input type="text" name="user" placeholder="Masukan User Anggota" class="input" value="<?= $user; ?>">
                    <?= $user_error;?>
                </tr></td>
                <tr><td>
                    <input type="password" name="pass" placeholder="Masukan Password Anggota" class="input" >
                    <?= $pass_error;?>
                </tr></td>
                <tr><td>
