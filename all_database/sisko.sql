...
CREATE DEFINER=`root`@`localhost` PROCEDURE `error` ()  NO SQL
select 'penuh_lord'$$
...
INSERT INTO `identitas` (`id_identitas`, `nama_sekolah`, `visi`, `misi`, `sejarah`, `lhome`, `lartikel`, `penerimaan`, `tahun_penerimaan`, `maks`, `tutup_pendaftaran`, `note`, `logo`) VALUES
...
(1, 1, 'item', 'green', 'pertama', 'http://localhost/Portal/Artikel/sekolah/15'),
...
--
DELIMITER $$
CREATE TRIGGER `maks` BEFORE INSERT ON `navitem` FOR EACH ROW BEGIN
...
(15, 'Forum Penerimaan Siswa Baru Sebentar Lagi Dibuka', 4, '<p>Penerimaan siswa didik baru&nbsp;</p>\n', '2019-06-17', 'public', 3, 'bf3968965c2329d9d9f3ab0e5cba9e44.png', NULL),
